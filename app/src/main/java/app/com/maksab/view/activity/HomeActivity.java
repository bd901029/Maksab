...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(HomeActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) !=
                PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(HomeActivity.this, android.Manifest
                .permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(HomeActivity.this, new String[]{android.Manifest.permission
                ...
                public void run() {
                    switch (position) {
                        case 1:
                            ...
                            break;
                        case 2:
                            addFragment(NearByFragment.newInstance(GetStoreListModel.TYPE_NEAR_BY), "NearByFragment",
                                    false);
                            break;
                        case 3:
                            if (PreferenceConnector.readBoolean(HomeActivity.this, PreferenceConnector.IS_LOGIN, false)) {
