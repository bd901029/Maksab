package app.com.maksab.imagepicker;
...
public abstract class PickerManager {
    ...
    public void startCropActivity() {
        if (uCrop == null) {
            ...
            options.setToolbarColor(Color.parseColor("#00BBFA"));
            options.setStatusBarColor(Color.parseColor("#00BBFA"));
            options.setActiveWidgetColor(Color.parseColor("#00BBFA"));
            uCrop = uCrop.withOptions(options);
        }
        uCrop.start(activity);
    }

    public void setAspectRatio(int a, int b) {
        aspectX = a;
        aspectY = b;
    }
