...
public class PartnerFragment extends Fragment {
	...
	private String[] aPartnerEnglish = {"All","A","B","C","D","E","F","G","H","I","J","K","L","M","N","O","P","Q","S","T", "U","V","W","X","Y","Z"};
	private String[] aPartnerArabic = {"الجميع","ا","ب","ت","ث","ج","ح","خ","د","ذ","ر","ز","س","ش","ص","ض","ط","ظ","ع","غ","ف", "ق","ك","ل","م","ن","ه","و","ي"};
