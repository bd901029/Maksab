...
public class PickerBuilder {
    ...
    public PickerBuilder(Activity activity, int type) {
        ...
        pickerManager = (type == PickerBuilder.SELECT_FROM_GALLERY) ? new ImagePickerManager(activity)
    ...
    public PickerBuilder setAspectRatio(int a, int b) {
        pickerManager.setAspectRatio(a, b);
        return this;
    }
